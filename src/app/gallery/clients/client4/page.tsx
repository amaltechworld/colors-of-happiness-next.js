            ...
            <section className="w-full py-14 pt-20">
                <div className="container mx-auto max-w-[1200px] bg-white p-6 md:p-12 lg:p-16">
                    ...
                    <div className="w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full p-5 bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600">
                                <p className="text-lg font-semibold">Image 1</p>
                                <p className="text-sm">
                                    /gallery/clients/client4/image1.jpg
                                </p>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    <p className="text-lg font-semibold">
                                        Image 2
                                    </p>
                                    <p className="text-sm">
                                        /gallery/clients/client4/image2.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image3.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-xs md:max-w-xl lg:max-w-3xl h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] mx-auto p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image4.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image5.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image6.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image7.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image8.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image9.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden p-2 md:p-3 lg:p-5">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image10.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image11.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden p-2 md:p-3 lg:p-5">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image12.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image13.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image14.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image15.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image16.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image17.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xs md:max-w-xl lg:max-w-3xl h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] mx-auto p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image18.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image19.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image20.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image21.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image22.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-xs md:max-w-xl lg:max-w-3xl h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] mx-auto p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image23.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image24.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image25.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image26.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image27.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image28.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image29.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client4/image30.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-purple-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client4/image31.jpg
                                </p>
                            </div>
                        </div>
                    </div>
