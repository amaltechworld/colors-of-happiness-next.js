...
export default function Client3Gallery() {
    ...
    const getImagePath = (imageNumber: number) => {
        return `/gallery/clients/client3/${screenSize}/image${imageNumber}.jpg`;
    };
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "ImageGallery",
                        name: "Amal & Priya Wedding Gallery",
                        description:
                            "Beautiful wedding gallery of Amal & Priya captured by Colors Of Happiness professional photographers.",
                        creator: {
                            "@type": "Organization",
                        ...
                        about: {
                            "@type": "Event",
                            name: "Amal & Priya Wedding",
                            eventStatus: "https://schema.org/EventScheduled",
                            eventAttendanceMode:
                                "https://schema.org/OfflineEventAttendanceMode",
                        },
                        image: [
                            "https://colorsofhappiness.com/gallery/clients/client3/image1.jpg",
                            "https://colorsofhappiness.com/gallery/clients/client3/image2.jpg",
                        ],
                    }),
                }}
            />
