...
export default function Client3Gallery() {
    return (
            ...
            <section className="w-full py-14 pt-20">
                <div className="container mx-auto max-w-[1200px] bg-white p-6 md:p-12 lg:p-16">
                    <h1 className="text-6xl text-gray-700 font-light text-center p-5">
                        Aakash <br /> Sree <br /> & <br /> Prabhul <br /> Priya
                    </h1>
                    ...
                    <div className="w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full p-5 bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600">
                                <p className="text-lg font-semibold">Image 1</p>
                                <p className="text-sm">
                                    /gallery/clients/client3/image1.jpg
                                </p>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    <p className="text-lg font-semibold">
                                        Image 2
                                    </p>
                                    <p className="text-sm">
                                        /gallery/clients/client3/image2.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image3.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-xs md:max-w-xl lg:max-w-3xl h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] mx-auto p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image4.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image5.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image6.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image7.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image8.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image9.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden p-2 md:p-3 lg:p-5">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image10.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image11.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden p-2 md:p-3 lg:p-5">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image12.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image13.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image14.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image15.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image16.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image17.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xs md:max-w-xl lg:max-w-3xl h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] mx-auto p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image18.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image19.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image20.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image21.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image22.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-xs md:max-w-xl lg:max-w-3xl h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] mx-auto p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image23.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image24.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image25.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image26.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image27.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-1 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image28.jpg
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image29.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-72 md:h-96 lg:h-screen overflow-hidden">
                            <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                                <div className="text-center text-gray-600 p-4">
                                    ...
                                    <p className="text-sm">
                                        /gallery/clients/client3/image30.jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="h-auto min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-2 md:p-3 lg:p-5 overflow-hidden">
                        <div className="w-full h-full bg-gray-200 border-4 border-green-500 flex items-center justify-center">
                            <div className="text-center text-gray-600 p-4">
                                ...
                                <p className="text-sm">
                                    /gallery/clients/client3/image31.jpg
                                </p>
                            </div>
                        </div>
                    </div>
