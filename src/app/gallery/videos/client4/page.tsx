...
const Client4Videos = () => {
    ...
    const videos = [
        {
            ...
            title: "Rohan & Kavya - Wedding Ceremony",
        },
        {
            id: "dQw4w9WgXcQ", // Replace with actual video ID
            title: "Rohan & Kavya - Reception Highlights",
        },
        {
            id: "dQw4w9WgXcQ", // Replace with actual video ID
            title: "Rohan & Kavya - Pre-Wedding Shoot",
        },
        {
            id: "dQw4w9WgXcQ", // Replace with actual video ID
            title: "Rohan & Kavya - Couple Portrait",
        },
    ];
    ...
    const structuredData = {
        ...
        "@type": "VideoGallery",
        name: "Rohan & Kavya Wedding Videos",
        description:
            "Beautiful wedding video collection of Rohan & Kavya captured by Colors Of Happiness",
